<%@ Page Title="" Language="C#" MasterPageFile="~/SiteIN.Master" AutoEventWireup="true" CodeBehind="component-avtars-chips.aspx.cs" Inherits="WebRedDS.component_avtars_chips" %>
			...
			<div class="page-content">
				...
				<div class="card">
					<div class="card-body">
						...
						<hr>
						<div class="chip">
							<img src="librerias/images/avatars/avatar-1.png" alt="Contact Person">John Doe</div>
						<div class="chip">
							<img src="librerias/images/avatars/avatar-2.png" alt="Contact Person">Jessica Doe</div>
						<div class="chip">
							<img src="librerias/images/avatars/avatar-3.png" alt="Contact Person">Michele Powa</div>
						<div class="chip">
							<img src="librerias/images/avatars/avatar-4.png" alt="Contact Person">Clark Natela</div>
						<div class="chip">
							<img src="librerias/images/avatars/avatar-5.png" alt="Contact Person">Anantu Painda <span class="closebtn" onclick="this.parentElement.style.display='none'">×</span>
						</div>
						<div class="chip">
							<img src="librerias/images/avatars/avatar-6.png" alt="Contact Person">Tiger Xink <span class="closebtn" onclick="this.parentElement.style.display='none'">×</span>
						</div>
						<div class="chip">
							<img src="librerias/images/avatars/avatar-7.png" alt="Contact Person">Salena Chain <span class="closebtn" onclick="this.parentElement.style.display='none'">×</span>
						</div>
						<hr>
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="chip chip-md bg-dark text-white">
							<img src="librerias/images/avatars/avatar-3.png" alt="Contact Person">Michele Powa <span class="closebtn" onclick="this.parentElement.style.display='none'">×</span>
						</div>
						<div class="chip chip-md bg-danger text-white">
							<img src="librerias/images/avatars/avatar-4.png" alt="Contact Person">Clark Natela <span class="closebtn" onclick="this.parentElement.style.display='none'">×</span>
						</div>
						<hr>
