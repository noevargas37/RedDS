<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reset-password.aspx.cs" Inherits="WebRedDS.authentication.reset_password" %>
								...
								<div class="card-body">
									<div class="p-5">
										<div class="text-start">
											<img src="../librerias/images/logo-img.png" width="180" alt="">
										</div>
										...
										<div class="d-grid gap-2">
											<button type="button" class="btn btn-primary">Change Password</button> <a href="signin.aspx" class="btn btn-light"><i class='bx bx-arrow-back mr-1'></i>Back to Login</a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-7">
								<img src="../librerias/images/login-images/forgot-password-frent-img.jpg" class="card-img login-img h-100" alt="...">
							</div>
						</div>
					</div>
				</div>
