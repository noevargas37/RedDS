<%@ Page Title="" Language="C#" MasterPageFile="~/SiteIN.Master" AutoEventWireup="true" CodeBehind="component-buttons.aspx.cs" Inherits="WebRedDS.component_buttons" %>
					...
					<div class="col col-lg-9 mx-auto">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="row row-cols-auto g-3">
									<div class="col">
										<button type="button" class="btn btn-primary px-5 radius-30"><i class='bx bx-user mr-1'></i>Person</button>
									</div>
									<div class="col">
										<button type="button" class="btn btn-secondary px-5 radius-30"><i class='bx bx-comment mr-1'></i>Comments</button>
									</div>
									<div class="col">
										<button type="button" class="btn btn-success px-5 radius-30"><i class='bx bx-home mr-1'></i>Home</button>
									</div>
									<div class="col">
										<button type="button" class="btn btn-danger px-5 radius-30"><i class='bx bx-bookmark mr-1'></i>Bookmark</button>
									</div>
									<div class="col">
										<button type="button" class="btn btn-warning px-5 radius-30"><i class='bx bx-heart-circle mr-1'></i>Love</button>
									</div>
									<div class="col">
										<button type="button" class="btn btn-info px-5 radius-30"><i class='bx bx-cloud-download mr-1'></i>Downloads</button>
									</div>
									<div class="col">
										<button type="button" class="btn btn-dark px-5 radius-30"><i class='bx bx-cloud-upload mr-1'></i>Upload</button>
									</div>
									<div class="w-100 border-top"></div>
									<div class="col">
