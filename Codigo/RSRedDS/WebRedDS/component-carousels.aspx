<%@ Page Title="" Language="C#" MasterPageFile="~/SiteIN.Master" AutoEventWireup="true" CodeBehind="component-carousels.aspx.cs" Inherits="WebRedDS.component_carousels" %>
								...
								<div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img src="librerias/images/gallery/17.png" class="d-block w-100" alt="...">
										</div>
										<div class="carousel-item">
											<img src="librerias/images/gallery/18.png" class="d-block w-100" alt="...">
										</div>
										<div class="carousel-item">
											<img src="librerias/images/gallery/19.png" class="d-block w-100" alt="...">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="card">
							<div class="card-body">
								<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img src="librerias/images/gallery/20.png" class="d-block w-100" alt="...">
										</div>
										<div class="carousel-item">
											<img src="librerias/images/gallery/21.png" class="d-block w-100" alt="...">
										</div>
										<div class="carousel-item">
											<img src="librerias/images/gallery/22.png" class="d-block w-100" alt="...">
										</div>
									</div>
						...
						<div class="card">
							<div class="card-body">
								<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img src="librerias/images/gallery/23.png" class="d-block w-100" alt="...">
										</div>
										<div class="carousel-item">
											<img src="librerias/images/gallery/24.png" class="d-block w-100" alt="...">
										</div>
										<div class="carousel-item">
											<img src="librerias/images/gallery/25.png" class="d-block w-100" alt="...">
										</div>
									</div>
						...
						<div class="card">
							<div class="card-body">
								<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img src="librerias/images/gallery/26.png" class="d-block w-100" alt="...">
										...
										<div class="carousel-item">
											<img src="librerias/images/gallery/27.png" class="d-block w-100" alt="...">
											<div class="carousel-caption d-none d-md-block">
										...
										<div class="carousel-item">
											<img src="librerias/images/gallery/28.png" class="d-block w-100" alt="...">
											<div class="carousel-caption d-none d-md-block">
						...
						<div class="card">
							<div class="card-body">
								<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img src="librerias/images/gallery/29.png" class="d-block w-100" alt="...">
										</div>
										<div class="carousel-item">
											<img src="librerias/images/gallery/30.png" class="d-block w-100" alt="...">
										</div>
										<div class="carousel-item">
											<img src="librerias/images/gallery/31.png" class="d-block w-100" alt="...">
										</div>
									</div>
								...
								<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
									<div class="carousel-inner">
										<div class="carousel-item active" data-bs-interval="10000">
											<img src="librerias/images/gallery/32.png" class="d-block w-100" alt="...">
										</div>
										<div class="carousel-item" data-bs-interval="2000">
											<img src="librerias/images/gallery/33.png" class="d-block w-100" alt="...">
										</div>
										<div class="carousel-item">
											<img src="librerias/images/gallery/34.png" class="d-block w-100" alt="...">
										</div>
									</div>
