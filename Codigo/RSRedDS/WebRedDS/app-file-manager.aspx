<%@ Page Title="" Language="C#" MasterPageFile="~/SiteIN.Master" AutoEventWireup="true" CodeBehind="app-file-manager.aspx.cs" Inherits="WebRedDS.app_file_manager" %>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="progress mt-3 h-7">
									...
									<div class="progress-bar bg-warning w-25" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
									<div class="progress-bar bg-danger w-25" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
								</div>
								<div class="mt-3"></div>
									...
									<div class="col-12 col-lg-4">
										<div class="card shadow-none border radius-15">
											<div class="card-body">
												...
												<div class="progress h-7">
													<div class="progress-bar bg-warning w-50" role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="card-body">
												<div class="d-flex align-items-center">
													...
													<div class="user-groups ms-auto">
														<img src="librerias/images/avatars/avatar-1.png" width="35" height="35" class="rounded-circle" alt="" />
														<img src="librerias/images/avatars/avatar-2.png" width="35" height="35" class="rounded-circle" alt="" />
													</div>
										...
										<div class="card shadow-none border radius-15">
											<div class="card-body">
												<div class="d-flex align-items-center">
													...
													<div class="user-groups ms-auto">
														<img src="librerias/images/avatars/avatar-4.png" width="35" height="35" class="rounded-circle" alt="" />
													</div>
												</div>
										...
										<div class="card shadow-none border radius-15">
											<div class="card-body">
												<div class="d-flex align-items-center">
													...
													<div class="user-groups ms-auto">
														<img src="librerias/images/avatars/avatar-7.png" width="35" height="35" class="rounded-circle" alt="" />
														<img src="librerias/images/avatars/avatar-8.png" width="35" height="35" class="rounded-circle" alt="" />
													</div>
												</div>
