<%@ Page Title="" Language="C#" MasterPageFile="~/SiteIN.Master" AutoEventWireup="true" CodeBehind="index2.aspx.cs" Inherits="WebRedDS.index2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
		<link href="librerias/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
	<link href="librerias/plugins/highcharts/css/highcharts.css" rel="stylesheet" />
</asp:Content>
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="librerias/images/avatars/avatar-1.png" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="librerias/images/avatars/avatar-2.png" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="librerias/images/avatars/avatar-3.png" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="librerias/images/avatars/avatar-4.png" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="librerias/images/avatars/avatar-7.png" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="">
													<img src="librerias/images/avatars/avatar-8.png" class="rounded-circle" width="40" height="40" alt="">
												</div>
												<div class="ms-2">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentScripts" runat="server">
	...
	<script src="librerias/plugins/vectormap/jquery-jvectormap-2.0.2.min.js"></script>
	<script src="librerias/plugins/vectormap/jquery-jvectormap-world-mill-en.js"></script>
	<!-- highcharts js -->
	<script src="librerias/plugins/highcharts/js/highcharts.js"></script>
	<script src="librerias/plugins/apexcharts-bundle/js/apexcharts.min.js"></script>
	<script src="librerias/js/index2.js"></script>
</asp:Content>
