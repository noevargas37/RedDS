<%@ Page Title="" Language="C#" MasterPageFile="~/SiteIN.Master" AutoEventWireup="true" CodeBehind="component-cards.aspx.cs" Inherits="WebRedDS.component_cards" %>
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 row-cols-xl-4">
					<div class="col">
						<div class="card">
							<img src="librerias/images/gallery/01.png" class="card-img-top" alt="...">
							<div class="card-body">
					...
					<div class="col">
						<div class="card">
							<img src="librerias/images/gallery/02.png" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
					...
					<div class="col">
						<div class="card">
							<img src="librerias/images/gallery/03.png" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
					...
					<div class="col">
						<div class="card">
							<img src="librerias/images/gallery/04.png" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
				...
				<div class="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3">
					<div class="col">
						<div class="card">
							<img src="librerias/images/gallery/05.png" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
					...
					<div class="col">
						<div class="card">
							<img src="librerias/images/gallery/06.png" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							</div>
					...
					<div class="col">
						<div class="card">
							<img src="librerias/images/gallery/07.png" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							</div>
				...
				<div class="row row-cols-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2">
					<div class="col">
						<div class="card mb-3">
							<img src="librerias/images/gallery/08.png" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
					...
					<div class="col">
						<div class="card">
							...
							<img src="librerias/images/gallery/09.png" class="card-img-bottom" alt="...">
						</div>
					</div>
				</div>
				<!--end row-->
				...
				<div class="row row-cols-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2">
					<div class="col">
						<div class="card">
							<div class="row g-0">
								<div class="col-md-4">
									<img src="librerias/images/gallery/10.png" alt="..." class="card-img">
								</div>
								<div class="col-md-8">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
					...
					<div class="col">
						<div class="card">
							<div class="row g-0">
								<div class="col-md-4">
									<img src="librerias/images/gallery/11.png" alt="..." class="card-img">
								</div>
								<div class="col-md-8">
									<div class="card-body">
										<h5 class="card-title">Card title</h5>
				...
				<div class="row row-cols-1 row-cols-md-1 row-cols-lg-2 row-cols-xl-2">
					<div class="col">
						<div class="card bg-dark text-white">
							<img src="librerias/images/gallery/12.png" class="card-img" alt="...">
					...
					<div class="col">
						<div class="card bg-dark text-white">
							<img src="librerias/images/gallery/13.png" class="card-img" alt="...">
							<div class="card-img-overlay">
								<h5 class="card-title text-white">Card title</h5>
								<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
								<p class="card-text">Last updated 3 mins ago</p>
				...
				<div class="card-group shadow">
					<div class="card border-end shadow-none">
						<img src="librerias/images/gallery/14.png" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-title">Card title</h5>
							<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
						</div>
					...
					<div class="card border-end shadow-none">
						<img src="librerias/images/gallery/15.png" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-title">Card title</h5>
					...
					<div class="card shadow-none">
						<img src="librerias/images/gallery/16.png" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-title">Card title</h5>
