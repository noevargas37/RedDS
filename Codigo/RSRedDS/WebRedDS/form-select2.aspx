<%@ Page Title="" Language="C#" MasterPageFile="~/SiteIN.Master" AutoEventWireup="true" CodeBehind="form-select2.aspx.cs" Inherits="WebRedDS.form_select2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
		<link href="librerias/plugins/select2/css/select2.min.css" rel="stylesheet" />
	<link href="librerias/plugins/select2/css/select2-bootstrap4.css" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentScripts" runat="server">
		<script src="librerias/plugins/select2/js/select2.min.js"></script>
	<script src="librerias/js/form-select2.js"></script>
</asp:Content>
